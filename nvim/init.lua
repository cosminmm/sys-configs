...
require('lazy').setup({
  ...
  -- NOTE: Configuration is made after current function:
  'dominikduda/vim_current_word',

  -- Activation of mini.cursorword is below lazy function:
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup({
    ...
    -- Configuration for autotag (windwp/nvim-ts-autotag):
    autotag = {
      enable = true,
